...
Before packaging, it installs project dependencies (`python -m pip install -e .`) to ensure Qt runtime modules (PySide6) are present for PyInstaller analysis and bundling.
